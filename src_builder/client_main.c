...
void lv_test_screen(lv_obj_t *screen) {
    ...
    lv_obj_set_style_text_font(info_label, lv_font_get_default(), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(info_label2, lv_font_get_default(), LV_PART_MAIN | LV_STATE_DEFAULT);
}
