...
/** @brief Creates a managed lv_style_t identified by name. */
extern lv_style_t* lv_style_create_managed(const char *name);
/** @brief Creates a managed lv_fs_drv_t identified by name. */
extern lv_fs_drv_t* lv_fs_drv_create_managed(const char *name);
/** @brief Creates a managed lv_layer_t identified by name. */
